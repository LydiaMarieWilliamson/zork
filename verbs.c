...
L42100:
   if (qempty_(prsvec_1.prso) || (objcts_1.oflag1[prsvec_1.prso - 1] & TAKEBT) == 0) {
      goto L10;
   }
...
// 						!OBJ HANDLE?
   if ((objcts_1.oflag1[prsvec_1.prso - 1] & LITEBT) != 0 && objcts_1.oadv[prsvec_1.prso - 1] == play_1.winner) {
      goto L44100;
   }
   rspeak_(400);
// 						!CANT DO IT.
...
L46225:
   ...
   if ((objcts_1.oflag1[prsvec_1.prso - 1] & TRANBT) != 0 || qempty_(prsvec_1.prso)) {
      goto L46300;
   }
...
// 						!DOWN ONE LEVEL.
   ...
   if ((objcts_1.oflag1[j - 1] & TRANBT) == 0 && (!((objcts_1.oflag2[j - 1] & OPENBT) != 0) || (objcts_1.oflag1[j - 1] & DOORBT + CONTBT) == 0)) {
      goto L10;
   }
   i = 417;
// 						!ASSUME IN ROOM.
...
L81300:
   ...
   if ((objcts_1.oflag2[prsvec_1.prso - 1] & OPENBT) != 0 || (objcts_1.oflag1[prsvec_1.prso - 1] & TRANBT) != 0) {
      goto L81400;
   }
   if ((objcts_1.oflag1[prsvec_1.prso - 1] & CONTBT) != 0) {
      goto L81200;
